...
# What happens if the user doesn't enter any students? It will try to print an empty
# list. How can you use an if statement (Control Flow) to only print the list if there
# is at least one student in there?
...
def print(students)
  if !students.empty?
    puts "No students currently enrolled".center(@width) if students.empty?
    i = 0
